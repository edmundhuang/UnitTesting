    ...
    Public Class FingerPrint
        ...
        Public Shared Function Value() As String
            If String.IsNullOrEmpty(fingerPrint) Then
                fingerPrint = GetHash("CPU >> " & cpuId() & vbLf & "BIOS >> " & biosId() & vbLf & "BASE >> " & baseId() & videoId() & vbLf & "MAC >> " & macId())
            End If
            Return fingerPrint
        End Function
        Private Shared Function GetHash(ByVal s As String) As String
            Dim sec As System.Security.Cryptography.MD5 = New MD5CryptoServiceProvider()
